        ...
        <div className="flex flex-col items-center justify-center bg-custom-light-gray w-[40vw] h-[44vh] space-y-6 rounded-sm shadow-md">
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="relative">
                    ...
                    <input className="px-10 w-[30vw] h-[30px] text-custom-dark border border-custom-gray rounded-sm" placeholder="Login" name="login" type="text" />
                </div>
                <div className="relative">
                    <IoKeyOutline className="absolute left-3 top-1/2 transform -translate-y-1/2 text-custom-dark"/>
                    <input className="px-10 w-[30vw] h-[30px] text-custom-dark border border-custom-gray rounded-sm" placeholder="Senha" name="password" type={hidden ? "password" : "text"} />
                    {hidden && (
                        <IoEyeOutline 
            ...
            <div className="flex flex-col space-y-2">
                <Button type="dark" className="w-[30vw]">Acessar</Button>
